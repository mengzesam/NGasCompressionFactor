Attribute VB_Name = "NGCompressionFactor"
'函数原型：
...
'double xipt2rhom_AGA(double xi_raw[],int ID_raw[],int NUM_x,double p,double t);
'double Z_SGERG88(double p,double t,double Hs,double d,double xCO2,double xH2);
'double Rhom_SGERG88(double p,double t,double Hs,double d,double xCO2,double xH2);
'double Rho_SGERG88(double p,double t,double Hs,double d,double xCO2,double xH2);
...
Public Function Z_SGERG(p As Double, t As Double, Hs As Double, d As Double, xCO2 As Double, xH2 As Double) As Double
    'd:相对密度（相对于空气），Hs：高位发热量 at normal conditions p:0.101325MPa,t:0 C
    Dim Z As Double
